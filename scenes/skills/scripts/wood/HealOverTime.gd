...
func _init():
	...
	mana = 20.0
	texture_path = "res://assets/skills/icons_skill/48x48/skill_icons36.png" # Thay bằng icon phù hợp
	projectile_scene = preload("res://scenes/skills/buff/wood/buffHeal.tscn")
	animation_name = "Heal"
