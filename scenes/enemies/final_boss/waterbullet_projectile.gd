extends Node2D
class_name WaterBulletsProjectile

@export var fly_speed: float = 750.0
	...
	if ground_ray:
		...
		if ground_ray.is_colliding():
			...
			if dot > -0.05:
				...
				# Nếu là tường thì vẫn destroy luôn
				_play_end_and_destroy()
				return
...
func _play_end_and_destroy() -> void:
	...
	# Play end animation
	if sprite and sprite.sprite_frames and sprite.sprite_frames.has_animation("end"):
		sprite.play("end")
